...
class IRActivityStopRepository @Inject constructor(
    ...
    private val rActivityStopRoomDatasource: RActivityStopRoomDatasource
        ...
        >(
    retrofitListAll = rActivityStopRetrofitDatasource::listAll,
    roomAddAll = rActivityStopRoomDatasource::addAll,
    roomDeleteAll = rActivityStopRoomDatasource::deleteAll,
    retrofitToEntity = RActivityStopRetrofitModel::retrofitModelToEntity,
    entityToRoom = RActivityStop::entityToRoomModel,
