...
@Composable
fun PressureListFertigationScreen(
    viewModel: PressureListFertigationViewModel = hiltViewModel(),
    ...
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            ...
            PressureListFertigationContent(
                list = uiState.list,
                set = viewModel::set,
...
@Composable
fun PressureListFertigationContent(
    list: List<Double>,
    set: (Double) -> Unit,
    updateDatabase: () -> Unit,
    flagAccess: Boolean,
...
@Composable
fun PressureListFertigationPagePreviewEmpty() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            PressureListFertigationContent(
                list = emptyList(),
...
@Preview(showBackground = true)
@Composable
fun PressureListFertigationPagePreviewWithData() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            PressureListFertigationContent(
                list = listOf(1.0),
...
@Preview(showBackground = true)
@Composable
fun PressureListFertigationPagePreviewWithFailureUpdate() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            PressureListFertigationContent(
                list = listOf(1.0),
...
@Preview(showBackground = true)
@Composable
fun PressureListFertigationPagePreviewWithProgressUpdate() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            PressureListFertigationContent(
                list = listOf(1.0),
...
@Preview(showBackground = true)
@Composable
fun PressureListFertigationPagePreviewWithFailureError() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            PressureListFertigationContent(
                list = listOf(1.0),
