...
@Preview(showBackground = true)
@Composable
fun CollectionListPagePreviewWithData() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            CollectionListContent(
                flowApp = FlowApp.REEL_FERT,
...
@Preview(showBackground = true)
@Composable
fun CollectionListPagePreviewWithDataAndButtonFinish() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            CollectionListContent(
...
@Preview(showBackground = true)
@Composable
fun CollectionListPagePreviewFailure() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            CollectionListContent(
                flowApp = FlowApp.HEADER_FINISH,
...
@Preview(showBackground = true)
@Composable
fun CollectionListPagePreviewInvalid() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            CollectionListContent(
                flowApp = FlowApp.HEADER_FINISH,
