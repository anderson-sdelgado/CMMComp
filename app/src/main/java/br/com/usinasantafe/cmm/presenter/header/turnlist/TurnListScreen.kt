...
@Composable
fun TurnListScreen(
    viewModel: TurnListViewModel = hiltViewModel(),
    onNavEquip: () -> Unit,
    onNavOS: () -> Unit
) {
    CMMTheme {
...
@Composable
fun TurnListPagePreviewWithData() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            TurnListContent(
                turnList = listOf(
...
@Preview(showBackground = true)
@Composable
fun TurnListPagePreviewWithFailureUpdate() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            TurnListContent(
                turnList = emptyList(),
...
@Preview(showBackground = true)
@Composable
fun TurnListPagePreviewProgressUpdate() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            TurnListContent(
                turnList = emptyList(),
...
@Preview(showBackground = true)
@Composable
fun TurnListPagePreviewWithFailureError() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            TurnListContent(
                turnList = emptyList(),
