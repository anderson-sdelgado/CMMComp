...
@Composable
fun SpeedListFertigationScreen(
    viewModel: SpeedListFertigationViewModel = hiltViewModel(),
...
@Composable
fun SpeedListFertigationContent(
    list: List<Pressure>,
    set: (Int) -> Unit,
    updateDatabase: () -> Unit,
    flagAccess: Boolean,
...
@Composable
fun SpeedListFertigationPagePreviewEmpty() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            SpeedListFertigationContent(
                list = emptyList(),
...
@Preview(showBackground = true)
@Composable
fun SpeedListFertigationPagePreviewWithData() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            SpeedListFertigationContent(
                list = listOf(
...
@Preview(showBackground = true)
@Composable
fun SpeedListFertigationPagePreviewWithFailureUpdate() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            SpeedListFertigationContent(
                list = listOf(
...
@Preview(showBackground = true)
@Composable
fun SpeedListFertigationPagePreviewWithProgressUpdate() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            SpeedListFertigationContent(
                list = listOf(
...
@Preview(showBackground = true)
@Composable
fun SpeedListFertigationPagePreviewWithFailureError() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            SpeedListFertigationContent(
                list = listOf(
