...
enum class TypeStop { CHECKLIST, IMPLEMENT, CALIBRATION }
enum class TypeItemMenu { ITEM_NORMAL, BUTTON_FINISH_HEADER, RETURN_LIST, PERFORMANCE, TRANSHIPMENT, IMPLEMENT, HOSE_COLLECTION, MECHANICAL_MAINTENANCE, TIRE, REEL }
