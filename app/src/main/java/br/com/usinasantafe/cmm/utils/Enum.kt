...
enum class Errors { FIELD_EMPTY, TOKEN, UPDATE, EXCEPTION, INVALID, HEADER_EMPTY, NOTE_MECHANICAL_OPEN, WITHOUT_NOTE_TRANSHIPMENT, TIME_INVALID_TRANSHIPMENT, LAST_NOTE_WORK }
...
enum class TypeMsg { ITEM_NORMAL, NOTE_FINISH_MECHANICAL }