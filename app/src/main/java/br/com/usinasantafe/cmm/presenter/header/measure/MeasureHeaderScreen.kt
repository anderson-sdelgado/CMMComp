...
@Composable
fun MeasureHeaderScreen(
    viewModel: MeasureHeaderViewModel = hiltViewModel(),
...
@Preview(showBackground = true)
@Composable
fun MeasureHeaderPagePreviewEmpty() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            MeasureHeaderContent(
                measure = "0,0",
...
@Preview(showBackground = true)
@Composable
fun MeasureHeaderPagePreviewInvalid() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            MeasureHeaderContent(
                measure = "10000,0",
...
@Preview(showBackground = true)
@Composable
fun MeasureHeaderPagePreviewFailure() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            MeasureHeaderContent(
                measure = "10000,0",
