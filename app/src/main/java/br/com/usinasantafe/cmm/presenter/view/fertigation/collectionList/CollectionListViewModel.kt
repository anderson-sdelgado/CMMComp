...
class CollectionListViewModel @Inject constructor(
    ...
    private fun updateState(block: CollectionListState.() -> CollectionListState) {
        _uiState.update(block)
    }
    
    fun setCloseDialog() = updateState { copy(flagDialog = false) }

    init { updateState { copy(flowApp = FlowApp.entries[this@CollectionListViewModel.flowApp]) }}
