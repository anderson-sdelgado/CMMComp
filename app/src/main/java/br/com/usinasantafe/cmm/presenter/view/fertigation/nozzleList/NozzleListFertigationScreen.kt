...
@Composable
fun NozzleListFertigationScreen(
    viewModel: NozzleListFertigationViewModel = hiltViewModel(),
...
@Composable
fun NozzleListFertigationContent(
    list: List<Nozzle>,
    set: (Int) -> Unit,
    updateDatabase: () -> Unit,
    flagAccess: Boolean,
...
@Composable
fun NozzleListFertigationPagePreview() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            NozzleListFertigationContent(
                list = emptyList(),
...
@Preview(showBackground = true)
@Composable
fun NozzleListFertigationPagePreviewWithData() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            NozzleListFertigationContent(
                list = listOf(
...
@Preview(showBackground = true)
@Composable
fun NozzleListFertigationPagePreviewWithFailureUpdate() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            NozzleListFertigationContent(
                list = listOf(
...
@Preview(showBackground = true)
@Composable
fun NozzleListFertigationPagePreviewWithProgressUpdate() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            NozzleListFertigationContent(
                list = listOf(
...
@Preview(showBackground = true)
@Composable
fun NozzleListFertigationPagePreviewWithFailureError() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            NozzleListFertigationContent(
                list = listOf(
