...
@Composable
fun CollectionFertigationScreen(
    viewModel: CollectionFertigationViewModel = hiltViewModel(),
    onNavCollectionList: () -> Unit,
) {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            val uiState by viewModel.uiState.collectAsStateWithLifecycle()
            CollectionFertigationContent(
                nroOS = uiState.nroOS,
...
@Composable
fun CollectionFertigationContent(
    nroOS: String,
    collection: String,
...
@Composable
fun CollectionFertigationPagePreview() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            CollectionFertigationContent(
                nroOS = "20000",
...
@Preview(showBackground = true)
@Composable
fun CollectionFertigationPagePreviewInvalid() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            CollectionFertigationContent(
                nroOS = "20000",
...
@Preview(showBackground = true)
@Composable
fun CollectionFertigationPagePreviewException() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            CollectionFertigationContent(
                nroOS = "20000",
