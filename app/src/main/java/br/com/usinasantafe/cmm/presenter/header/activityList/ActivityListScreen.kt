    ...
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            ...
            ActivityListScreenContent(
                ...
                setIdActivity = viewModel::setIdActivityHeader,
...
@Composable
fun ActivityListScreenPagePreviewWithData() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            ActivityListScreenContent(
                activityList = listOf(
...
@Preview(showBackground = true)
@Composable
fun ActivityListScreenPagePreviewWithFailureUpdate() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            ActivityListScreenContent(
                activityList = listOf(
...
@Preview(showBackground = true)
@Composable
fun ActivityListScreenPagePreviewWithProgressUpdate() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            ActivityListScreenContent(
                activityList = listOf(
...
@Preview(showBackground = true)
@Composable
fun ActivityListScreenPagePreviewWithFailureError() {
    CMMTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            ActivityListScreenContent(
                activityList = listOf(
