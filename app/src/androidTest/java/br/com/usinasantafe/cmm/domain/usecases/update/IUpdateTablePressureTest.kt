...
class IUpdateTablePressureTest {
    ...
    @Inject
    lateinit var usecase: UpdateTablePressure
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTablePressure -> IPressureRepository.listAll -> IPressureRetrofitDatasource.listAll -> java.net.SocketTimeoutException: timeout",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTablePressure -> IPressureRepository.listAll -> IPressureRetrofitDatasource.listAll -> java.lang.IllegalStateException: Expected BEGIN_ARRAY but was BEGIN_OBJECT at line 1 column 2 path \$",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTablePressure -> IPressureRepository.listAll -> IPressureRetrofitDatasource.listAll -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
    ...
    fun verify_return_data_if_success() =
        runTest {
            ...
            val roomModelList = pressureDao.all()
            assertEquals(
                roomModelList.size,
                1
            )
    ...
    private val resultPressureRetrofit = """
                [{"id":1,"idNozzle":10,"value":10.0,"speed":1}]
            """.trimIndent()
