...
class IUpdateTableItemCheckListByNroEquipTest {
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableItemCheckListByNroEquip -> IItemCheckListRepository.listByNroEquip -> IItemCheckListRetrofitDatasource.listByNroEquip -> java.net.ConnectException: Failed to connect to localhost/127.0.0.1:8080",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableItemCheckListByNroEquip -> IItemCheckListRepository.listByNroEquip -> IItemCheckListRetrofitDatasource.listByNroEquip -> java.lang.IllegalStateException: Expected BEGIN_ARRAY but was BEGIN_OBJECT at line 1 column 2 path \$",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableItemCheckListByNroEquip -> IItemCheckListRepository.listByNroEquip -> IItemCheckListRetrofitDatasource.listByNroEquip -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
    ...
    fun verify_return_data_if_success() =
        runTest {
            ...
            val roomModelList = itemCheckListDao.all()
            assertEquals(
                roomModelList.size,
                2
            )
