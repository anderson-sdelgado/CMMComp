...
class IUpdateTableNozzleTest {
    ...
    @Inject
    lateinit var usecase: UpdateTableNozzle
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableNozzle -> INozzleRepository.listAll -> INozzleRetrofitDatasource.listAll -> java.net.SocketTimeoutException: timeout",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableNozzle -> INozzleRepository.listAll -> INozzleRetrofitDatasource.listAll -> java.lang.IllegalStateException: Expected BEGIN_ARRAY but was BEGIN_OBJECT at line 1 column 2 path \$",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableNozzle -> INozzleRepository.listAll -> INozzleRetrofitDatasource.listAll -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
    ...
    fun verify_return_data_if_success() =
        runTest {
            ...
            mockWebServer.enqueue(
                MockResponse().setBody(resultNozzleRetrofit)
            )
            ...
            val roomModelList = nozzleDao.all()
            assertEquals(
                roomModelList.size,
                1
            )
    ...
    private val resultNozzleRetrofit = """
