...
class IUpdateTableROSActivityTest {
    ...
    @Inject
    lateinit var usecase: UpdateTableROSActivity
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    failure = "IUpdateTableROSActivity -> IGetToken -> IEquipRepository.getNroEquipMain -> IEquipSharedPreferencesDatasource.getNro -> java.lang.NullPointerException",
                    flagProgress = true,
                    currentProgress = 1f,
                    levelUpdate = null,
                )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableROSActivity -> IROSActivityRepository.listAll -> IROSActivityRetrofitDatasource.listAll -> java.lang.IllegalStateException: Expected BEGIN_ARRAY but was BEGIN_OBJECT at line 1 column 2 path \$",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                UpdateStatusState(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableROSActivity -> IROSActivityRepository.listAll -> IROSActivityRetrofitDatasource.listAll -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
    ...
    fun verify_return_data_if_success() =
        runTest {
            ...
            val roomModelList = rOSActivityDao.all()
            assertEquals(
                roomModelList.size,
                2
            )
    ...
    private val resultROSActivityRetrofit = """
        [
          {"idOS":20,"idActivity":10},
          {"idOS":30,"idActivity":11}
        ]
    """.trimIndent()
