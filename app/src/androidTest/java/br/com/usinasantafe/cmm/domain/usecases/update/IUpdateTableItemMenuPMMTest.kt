...
class IUpdateTableItemMenuPMMTest {
    ...
    @Inject
    lateinit var usecase: UpdateTableItemMenuPMM
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableItemMenuPMM -> IGetToken -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableItemMenuPMM -> IItemMenuPMMRepository.listAll -> IItemMenuPMMRetrofitDatasource.listAll -> java.lang.IllegalStateException: Expected BEGIN_ARRAY but was BEGIN_OBJECT at line 1 column 2 path \$",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableItemMenuPMM -> IItemMenuPMMRepository.listAll -> IItemMenuPMMRetrofitDatasource.listAll -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
    ...
    fun verify_return_data_if_success() =
        runTest {
            ...
            val roomModelList = itemMenuPMMDao.all()
            assertEquals(
                roomModelList.size,
                2
            )
