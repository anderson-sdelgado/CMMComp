        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableStop -> IGetToken -> IConfigRepository.get -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableStop -> IStopRepository.listAll -> IStopRetrofitDatasource.listAll -> java.net.ConnectException: Failed to connect to localhost/127.0.0.1:8080",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableStop -> IStopRepository.listAll -> IStopRetrofitDatasource.listAll -> java.lang.IllegalStateException: Expected BEGIN_ARRAY but was BEGIN_OBJECT at line 1 column 2 path \$",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
        ...
        runTest {
            ...
            assertEquals(
                ...
                ResultUpdateModel(
                    ...
                    flagDialog = true,
                    flagFailure = true,
                    failure = "IUpdateTableStop -> IStopRepository.listAll -> IStopRetrofitDatasource.listAll -> java.lang.NullPointerException",
                    currentProgress = 1f,
                    levelUpdate = null,
                )
            )
