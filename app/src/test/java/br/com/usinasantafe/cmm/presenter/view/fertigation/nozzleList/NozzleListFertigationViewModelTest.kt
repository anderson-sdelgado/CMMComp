...
class NozzleListFertigationViewModelTest {
    ...
    private val viewModel = NozzleListFertigationViewModel(
    ...
    @Test
    fun `set - Check return failure if have error in SetIdNozzle`() =
        runTest {
            whenever(
                setIdNozzle(
                    id = 1
