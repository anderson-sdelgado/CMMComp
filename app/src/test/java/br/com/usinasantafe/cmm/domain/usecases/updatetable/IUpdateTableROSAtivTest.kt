...
class IUpdateTableROSAtivTest {

    private val getToken = mock<GetToken>()
    private val rOSAtivRepository = mock<ROSAtivRepository>()
    private val updateTableROSAtiv = IUpdateTableROSAtiv(
        getToken = getToken,
        rOSAtivRepository = rOSAtivRepository
    )
    ...
    fun `Check return failure if have error in ROSAtivRepository recoverAll`() =
        runTest {
            ...
            whenever(
                rOSAtivRepository.recoverAll("token")
            ).thenReturn(
                resultFailure(
                    "Error",
                    "Exception",
