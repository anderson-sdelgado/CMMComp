package br.com.usinasantafe.cmm.presenter.view.motomec.performance.performancelist
...
class PerformanceListViewModelTest {
    ...
    fun `performanceList - Check return failure if have error in usecase ListPerformance`() =
        runTest {
            ...
            assertEquals(
                ...
                "PerformanceListViewModel.performanceList -> ListPerformance -> java.lang.Exception"
            )
            assertEquals(
    ...
    @Test
    fun `performanceList - Check return true if listPerformance execute successfully`() =
        runTest {
            whenever(
                listPerformance()
            ).thenReturn(
            ...
            viewModel.performanceList()
            assertEquals(
                viewModel.uiState.value.performanceList,
                listOf(
                    ItemPerformanceScreenModel(
                        id = 1,
                        nroOS = 123456,
