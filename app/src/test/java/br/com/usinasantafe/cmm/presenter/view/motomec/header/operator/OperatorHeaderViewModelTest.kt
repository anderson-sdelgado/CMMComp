package br.com.usinasantafe.cmm.presenter.view.motomec.header.operator
...
import br.com.usinasantafe.cmm.presenter.view.motomec.header.operator.OperatorHeaderViewModel
...
class OperatorHeaderViewModelTest {
    ...
    fun `setTextField - Check return failure if field is empty`() =
        runTest {
            ...
            assertEquals(
                viewModel.uiState.value.status.failure,
                "OperatorHeaderViewModel.setTextField -> OperatorHeaderViewModel.validateAndSet -> OperatorHeaderViewModel.updateState -> Field Empty!"
            )
            assertEquals(
    ...
    fun `setTextField - Check return failure if have error in usecase HasRegOperator`() =
        runTest {
            ...
            assertEquals(
                viewModel.uiState.value.status.failure,
                "OperatorHeaderViewModel.setTextField -> OperatorHeaderViewModel.validateAndSet -> OperatorHeaderViewModel.set -> ICheckRegOperator -> java.lang.Exception"
            )
            assertEquals(
                viewModel.uiState.value.status.flagProgress,
                false
    ...
    fun `setTextField - Check return failure if have error in usecase SetRegOperator`() =
        runTest {
            ...
            assertEquals(
                viewModel.uiState.value.status.failure,
                "OperatorHeaderViewModel.setTextField -> OperatorHeaderViewModel.validateAndSet -> OperatorHeaderViewModel.set -> ISetRegOperator -> java.lang.Exception"
            )
            assertEquals(
                viewModel.uiState.value.status.flagProgress,
                false
